...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    private var NOTIFICATION_CHANNEL_ID = "com.shapeecloudjsc.firebasecloudmessaging"
    ...
    private fun getNotificationIcon(): Int {
        ...
        return if (useWhiteIcon) R.drawable.ic_stat_ic_notification else R.drawable.ic_stat_ic_notification
    }
}